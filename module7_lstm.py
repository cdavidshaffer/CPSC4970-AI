    ...
    def create_model(input_shape, output_shape):
        model = Sequential(
            [Input(shape=input_shape[1:]),
             LSTM(700, activation=activations.sigmoid, return_sequences=True),
             Dropout(0.25),
             LSTM(700, activation=activations.sigmoid),
             Dropout(0.25),
...
def main_kafka():
    ...
    #m.load_weights("kafka_lstm_weights/kafka-0002-2.9242.hdf5")
    m.fit(epochs=2, batch_size=5000, prefix='kafka_lstm_weights/kafka')
